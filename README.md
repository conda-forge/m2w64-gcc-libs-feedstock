About m2w64-gcc-libs-feedstock
==============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/m2w64-gcc-libs-feedstock/blob/main/LICENSE.txt)


About m2w64-gcc-libs
--------------------
...
<table>
  ...
  <tr>
    ...
    <td>
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=20414&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/m2w64-gcc-libs-feedstock?branchName=main">
          </a>
        </summary>
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=20414&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/m2w64-gcc-libs-feedstock?branchName=main&jobName=win&configuration=win%20win_64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
Installing m2w64-gcc-libs
=========================

Installing `m2w64-gcc-libs` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Once the `conda-forge` channel has been enabled, `libgcc, libgfortran, libgfortran5, libgomp, libstdcxx` can be installed with `conda`:

```
conda install libgcc libgfortran libgfortran5 libgomp libstdcxx
```

or with `mamba`:

```
mamba install libgcc libgfortran libgfortran5 libgomp libstdcxx
```

It is possible to list all of the versions of `libgcc` available on your platform with `conda`:

```
conda search libgcc --channel conda-forge
```

or with `mamba`:

```
mamba search libgcc --channel conda-forge
```
...
mamba repoquery search libgcc --channel conda-forge

# List packages depending on `libgcc`:
mamba repoquery whoneeds libgcc --channel conda-forge

# List dependencies of `libgcc`:
mamba repoquery depends libgcc --channel conda-forge
```
...
Updating m2w64-gcc-libs-feedstock
=================================

If you would like to improve the m2w64-gcc-libs recipe or build a new
...
Note that all branches in the conda-forge/m2w64-gcc-libs-feedstock are
